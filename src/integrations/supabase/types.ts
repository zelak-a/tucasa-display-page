...
export type Database = {
  ...
  public: {
    ...
    Functions: {
      is_role_active: {
        Args: { _end_date: string; _is_active: boolean; _start_date: string }
        Returns: boolean
      }
      user_branch_ids: { Args: { _user_id: string }; Returns: string[] }
      user_conference_ids: { Args: { _user_id: string }; Returns: string[] }
      user_has_any_role: { Args: { _user_id: string }; Returns: boolean }
      user_has_permission: {
        Args: { _permission: string; _user_id: string }
        Returns: boolean
      }
      user_is_union_leader: { Args: { _user_id: string }; Returns: boolean }
      user_zone_ids: { Args: { _user_id: string }; Returns: string[] }
    }
    Enums: {
